...
const DEFINITIONS = [
  ...
  feature({ key: "student.library_reader", name: "Alex B. Morrison Library reader", pathway: "student", category: "Learning", description: "Opens free or course-assigned books from the governed Library catalog.", helpText: "Open books require a published record; assigned books also require membership in the linked course. Commercial previews never grant reading access.", readiness: "built_in_part", defaultValue: true, sensitivity: "sensitive", disableBehavior: "read_only", dependencies: ["shared.course_access"], tags: ["library", "book", "reader"] }),
  ...
  feature({ key: "publisher.commerce", name: "Publication purchases and rentals", pathway: "publisher", category: "Commerce", description: "Creates access after a verified purchase or rental event and routes seller allocations through Stripe Connect payouts.", helpText: "Pilot-ready but disabled by default. The browser never grants paid access; seller, rights, tax, listing, refund, dispute, and production approval gates must pass first.", readiness: "pilot_testing", defaultValue: false, sensitivity: "critical", disableBehavior: "read_only", dependencies: ["publisher.catalog", "shared.billing"], tags: ["purchase", "rental", "payout"] }),
