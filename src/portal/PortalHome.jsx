      ...
      <main>
        <section className="portal-choice-hero">
          ...
          <div className="portal-choice-mark">
            <img className="portal-choice-hero-image" src="/landing/landing-learning-planner.png" alt="An organized learning desk with notebook, planner, books, and laptop" width="1536" height="1024" />
        ...
        <section style={{ maxWidth: 1180, margin: "0 auto 54px", padding: "0 28px" }} aria-label="Interactive demonstration accounts">
          <div style={{ padding: 28, color: "#18284a", background: "#fffdf8", border: "1px solid #ded6c8", borderRadius: 22, boxShadow: "0 18px 50px rgba(16,27,51,.08)" }}>
            ...
            <div className="portal-demo-team">
              <a href="#/tour/student"><img src="/demo-media/brooke-portrait.png" alt="Brooke, student tour guide" width="1122" height="1402" loading="lazy" decoding="async" /><span><strong>Brooke</strong><small>University student</small></span></a>
              <a href="#/tour/professor"><img src="/demo-media/atlas-portrait.png" alt="Atlas, professor guide" width="1122" height="1402" loading="lazy" decoding="async" /><span><strong>Atlas</strong><small>Professor</small></span></a>
              <a href="#/tour/k12"><img src="/demo-media/jaylen-portrait.png" alt="Jaylen, K–12 student guide" width="1122" height="1402" loading="lazy" decoding="async" /><span><strong>Jaylen</strong><small>K–12 student</small></span></a>
            </div>
          </div>
        </section>
        ...
        <section className="portal-home-share" aria-labelledby="portal-home-share-title">
          ...
          <img src="/ednotebook-share-card-v2.png" alt="EdNotebook invitation to make learning fun, connected, and high tech" width="1729" height="910" loading="lazy" decoding="async" />
        </section>
