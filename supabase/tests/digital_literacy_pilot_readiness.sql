...
values
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'pilot-professor@example.test', '{"full_name":"Pilot Professor"}', now(), now()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 'pilot-student@example.test', '{"full_name":"Pilot Student"}', now(), now());
