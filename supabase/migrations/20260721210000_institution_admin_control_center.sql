...
insert into public.feature_definitions (
  ...
  ('professor.assignment_templates','Assignment templates','professor','Assignments','Creates reusable assignment structures, rubrics, limits, and learner instructions.','Templates do not publish themselves; the professor controls placement and release.','boolean','boolean','true'::jsonb,'[]'::jsonb,null,null,array['platform','institution','pathway','course','account' ]::text[],true,true,'ordinary','low','implemented','hide','Turning this off hides the feature while preserving its records. It can affect professor pathways.',null,'int…9996 tokens truncated…ccount sign-in and should not be enabled without that required control or service.'),
